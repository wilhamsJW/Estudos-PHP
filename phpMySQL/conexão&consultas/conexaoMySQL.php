<?php 
      ...
      //a conexão com o banco de dados está sendo feita em outra pasta, leia o arquivo segurança


     /* TODO ESSE CÓDIGO FOI ENVIADO PARA PASTA CONEXÃO, LEIA O ARQUIVO SEGURANÇA E ENTENDA O MOTIVO
